package com.turf.common.constants;
...
public class ResultInfoConstants {
    ...
    public static final ResultInfo UNAUTHORISED = new ResultInfo("11000009", "UNAUTHORISED", HttpStatus.UNAUTHORIZED.name(), "F");
    public static final ResultInfo FILE_SIZE_LIMIT_EXCEEDED = new ResultInfo("11000009", "UNAUTHORISED", HttpStatus.UNAUTHORIZED.name(), "F");
